...
- **변수의 이름은 의미 있게 짓는다**
  ...
  - `int enemyCount`, `intplayerHP`    <span style="color: green;">Good</span>
...
```
- 스택 메모리 여역에 선언된 `player` 변수를 통해 힙 메모리 영역에 저장되어 있는 실제 데이터에 접근
...
#### 참고자료
1. [유튜브 고박사의 유니티 노트 [Unity C#] #01 변수 : 변수와 데이터 (Variable and data)](https://www.youtube.com/watch?v=YKiTGbPIZKQ&list=PLC2Tit6NyVicT5cCqILMWXpXVEoM9ufyH&index=1)
